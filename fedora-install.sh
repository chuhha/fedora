...
sleep 1; clear
echo 'Система будет автоматически перезагружена через 4 секунд'
sleep 1; clear
echo 'Система будет автоматически перезагружена через 3 секунд'
sleep 1; clear
echo 'Система будет автоматически перезагружена через 2 секунд'
sleep 1; clear
echo 'Система будет автоматически перезагружена через 1 секунд'
echo 'Перезагрузка...'
sleep 2
reboot